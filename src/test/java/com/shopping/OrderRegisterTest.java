...
public class OrderRegisterTest {
    ...
    public void setUp() {
        ...
        taxCalculator = new StubTaxCalculator(new BigDecimal(10));
    ...
    public void canPlaceOrder() {
        ...
        BigDecimal expectedTax = new BigDecimal(10).setScale(2, RoundingMode.HALF_UP);
        BigDecimal expectedTotal = new BigDecimal(104.74).setScale(2, RoundingMode.HALF_UP);
